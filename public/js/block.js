$(document).ready(function(){
  ...
  $.get('cedulasPen', null, function( data)
  {
    $.each( data, function( key, val) {
        fechas.push({ fecha: key, total: val });
     });
