      ...
      <div class="filtros">
         <table style="width:100%">
            <tr class="filtros">
               ...
               <td>
                 <div align="left">
                  <label for="nivel"> Y selecciona un nivel: </label>
                  <span>
                    <select id="nivel" name="nivel" style="width: 50%;">
                      @foreach($niveles as $nvl)
                       <option value="{{ $nvl->cat_subcve }}">{{ $nvl->cat_subcve }}</option>
                      @endforeach
                    </select>
                  </span>
                 </div>
               </td>
               <td><div align="right"><input type="submit" class="btn btn-primary waves-effect waves-light" name="seleccion" value="Solicitar"/></div></td></tr></table></td>
               <td>
                 <table style="width: 100%"><tr>
                 <td><div align="right">
