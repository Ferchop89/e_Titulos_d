				...
				<div class="form">
				      		...
				      		<input type="text" id="nombres" name="nombres" class="width_n mayus form-control" placeholder="Nombre(s)" value="{{old('nombres', $alumno->nombres)}}" @if ($errors->has('nombres')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['nombres']))
										<input type="text" id="nombres" name="nombres" class="width_n mayus form-control" placeholder="Nombre(s)" value="<?=$_POST['nombres']?>">
									@else
										<input type="text" id="nombres" name="nombres" class="width_n mayus form-control" placeholder="Nombre(s)" value="{{ old('nombres') }}">
									@endif
								@endif
				      		...
				      		<input type="text" id="apellido1" name="apellido1" class="width_n mayus form-control" placeholder="Primer apellido" value="{{old('apellido1', $alumno->apellido1)}}" @if ($errors->has('apellido1')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['apellido1']))
										<input type="text" id="apellido1" name="apellido1" class="width_n mayus form-control" placeholder="Primer apellido" value="<?=$_POST['apellido1']?>">
									@else
										<input type="text" id="apellido1" name="apellido1" class="width_n mayus form-control" placeholder="Primer apellido" value="{{ old('apellido1') }}">
									@endif
								@endif
				      		...
				      		<input type="text" id="apellido2" name="apellido2" class="width_n mayus form-control" placeholder="Segundo apellido" value="{{old('apellido2', $alumno->apellido2)}}" @if ($errors->has('apellido2')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['apellido2']))
										<input type="text" id="apellido2" name="apellido2" class="width_n mayus form-control" placeholder="Segundo apellido" value="<?=$_POST['apellido2']?>">
									@else
										<input type="text" id="apellido2" name="apellido2" class="width_n mayus form-control" placeholder="Segundo apellido" value="{{ old('apellido2') }}">
									@endif
								@endif
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		...
				      		<input type="text" id="curp" name="curp" class="width_n mayus form-control" maxlength="18" placeholder="CURP (18 caracteres):" value="{{old('curp', $alumno->curp)}}" @if ($errors->has('curp')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['curp']))
										<input type="text" id="curp" name="curp" class="width_n mayus form-control" maxlength="18" placeholder="CURP (18 caracteres):" value="<?=$_POST['curp']?>">
									@else
										<input type="text" id="curp" name="curp" class="width_n mayus form-control" maxlength="18" placeholder="CURP (18 caracteres):" value="{{ old('curp') }}">
									@endif
								@endif
								@if ($errors->has('curp'))
										<span class="help-block">
				      		...
				      		<input type="text" id="num_fijo" name="num_tel" class="width_n form-control" placeholder="10 dígitos (lada incluida):" maxlength="10" value="{{old('num_tel', $alumno->tel_fijo)}}" @if ($errors->has('num_tel')) autofocus @endif>
								@else
									@if(isset($_POST['num_tel']))
										<input type="text" id="num_fijo" name="num_tel" class="width_n form-control" placeholder="10 dígitos (lada incluida):" maxlength="10" value="<?=$_POST['num_tel']?>">
									@else
										<input type="text" id="num_fijo" name="num_tel" class="width_n form-control" placeholder="10 dígitos (lada incluida):" maxlength="10" value="{{ old('num_tel') }}">
									@endif
								@endif
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		...
				      		<input type="text" id="num_cel" name="num_cel" class="width_n form-control" placeholder="10 dígitos (lada incluida):" maxlength="10" value="{{old('num_cel', $alumno->tel_celular)}}" @if ($errors->has('num_cel')) autofocus @endif>
								@else
									@if(isset($_POST['num_cel']))
										<input type="text" id="num_cel" name="num_cel" class="width_n form-control" placeholder="10 dígitos (lada incluida):" maxlength="10" value="<?=$_POST['num_cel']?>">
									@else
										<input type="text" id="num_cel" name="num_cel" class="width_n form-control" placeholder="10 dígitos (lada incluida):" maxlength="10" value="{{ old('num_cel') }}">
									@endif
								@endif
				      		...
				      		<input type="email" id="correo" name="correo" class="width_n form-control" placeholder="email@correo.com" value="{{old('correo', $alumno->correo)}}" @if ($errors->has('correo')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toLowerCase()">
								@else
									@if(isset($_POST['correo']))
										<input type="email" id="correo" name="correo" class="width_n form-control" placeholder="email@correo.com" value="<?=$_POST['correo']?>">
									@else
										<input type="email" id="correo" name="correo" class="width_n form-control" placeholder="email@correo.com" value="{{ old('correo') }}">
									@endif
								@endif
					...
					<div class="form-group row">
						...
						<h4>Domicilio.</h4><br>
					   	...
					   	<div class="col-sm-10">
						    	...
						    	<input class="col-sm-8" type="text" id="codigo_postal" name="codigo_postal" class="width_n form-control" placeholder="Código postal" maxlength="5" onclick="visualiza()" value="{{old('codigo_postal', $info_dl->codigo_postal)}}" @if ($errors->has('codigo_postal')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['codigo_postal']))
										<input class="col-sm-8" type="text" id="codigo_postal" name="codigo_postal" class="width_n form-control" placeholder="Código postal" maxlength="5" onclick="visualiza()" value="<?=$_POST['codigo_postal']?>">
									@else
										<input class="col-sm-8" type="text" id="codigo_postal" name="codigo_postal" class="width_n form-control" placeholder="Código postal" maxlength="5" onclick="visualiza()" value="{{old('codigo_postal')}}">
									@endif
								@endif
								<input class="col-sm-2" type="submit" name="filtraXCodigo" id="filtraXCodigo" value="Buscar" />
									@if ($errors->has('codigo_postal'))
			 							<span class="help-block">
			 								<br><br><strong>{{ $errors->first('codigo_postal') }}</strong>
			 							</span>
			 					 	@endif
							</div>
					 	</div>
								...
								@if(isset($estados))
									<select name="estado" class="width_n form-control">
										@foreach($estados as $edo)
											@if(isset($info_dl->estado) && $info_dl->estado == mb_strtoupper($edo->d_estado,'utf-8'))
												<option value="{{mb_strtoupper($edo->d_estado,'utf-8')}}" selected>{{mb_strtoupper($edo->d_estado,'utf-8')}}</option>
											@else
												@if((isset($_POST['estado']) && $_POST['estado'] == mb_strtoupper($edo->d_estado,'utf-8')) || (old('estado') == mb_strtoupper($edo->d_estado,'utf-8')))
													<option value="{{mb_strtoupper($edo->d_estado,'utf-8')}}" selected>{{mb_strtoupper($edo->d_estado,'utf-8')}}</option>
												@else
													<option value="{{mb_strtoupper($edo->d_estado,'utf-8')}}">{{mb_strtoupper($edo->d_estado,'utf-8')}}</option>
												@endif
											@endif
										@endforeach
									</select>
								@else
						    	<select name="estado" class="width_n form-control" disabled></select>
								@endif
					   	...
					   	<div class="col-sm-10">
									...
									<select name="municipio" class="width_n form-control">
										@foreach($municipios as $mnp)
											@if(isset($info_dl->municipio) && $info_dl->municipio == mb_strtoupper($mnp->d_mnpio,'utf-8'))
												<option value="{{mb_strtoupper($mnp->d_mnpio,'utf-8')}}" selected>{{mb_strtoupper($mnp->d_mnpio,'utf-8')}}</option>
											@else
												@if((isset($_POST['municipio']) && $_POST['municipio'] == mb_strtoupper($mnp->d_mnpio,'utf-8')) || (old('municipio') == mb_strtoupper($mnp->d_mnpio,'utf-8')))
													<option value="{{mb_strtoupper($mnp->d_mnpio,'utf-8')}}" selected>{{mb_strtoupper($mnp->d_mnpio,'utf-8')}}</option>
												@else
					   	...
					   	<div class="col-sm-10">
								...
								<select name="colonia" class="width_n form-control">
									@foreach($colonias as $col)
										@if(isset($info_dl->colonia) && $info_dl->colonia == mb_strtoupper($col->d_asenta,'utf-8'))
											<option value="{{mb_strtoupper($col->d_asenta,'utf-8')}}" selected>{{mb_strtoupper($col->d_asenta,'utf-8')}}</option>
										@else
											@if((isset($_POST['colonia']) && $_POST['colonia'] == mb_strtoupper($col->d_asenta,'utf-8')) || (old('colonia') == mb_strtoupper($col->d_asenta,'utf-8')))
												<option value="{{mb_strtoupper($col->d_asenta,'utf-8')}}" selected>{{mb_strtoupper($col->d_asenta,'utf-8')}}</option>
											@else
									...
									@else
						     		<select name="colonia" class="width_n form-control" disabled></select>
									@endif
					...
					<div class="form-group row">
					   	...
					   	<div class="col-sm-10">
								...
								@else
									@if(isset($_POST['calle_numero']))
										<input type="text" id="calle_numero" name="calle_numero" class="width_n form-control" placeholder="Calle y número" value="<?=$_POST['calle_numero']?>">
									@else
										<input type="text" id="calle_numero" name="calle_numero" class="width_n form-control" placeholder="Calle y número" value="{{ old('calle_numero') }}">
									@endif
								@endif
					   	...
					   	<div class="col-sm-10">
								<table style="width:20%;"><tr>
									@if(isset($info_dl->labora))
										<td><p><input id="empleo_si" name="empleo" type="radio" value=1 @if(old('empleo', $info_dl->labora) == 1) checked @endif/> Si</p></td>
										<td><p><input id="empleo_no" name="empleo" type="radio" value=0 @if(old('empleo', $info_dl->labora) == 0) checked @endif/> No</p></td>
									@else
										@if(isset($_POST['empleo']))
											@if($_POST['empleo'] == 1)
												<td><p><input id="empleo_si" name="empleo" type="radio" value=1 checked/> Si</p></td>
												<td><p><input id="empleo_no" name="empleo" type="radio" value=0 /> No</p></td>
											@else
												<td><p><input id="empleo_si" name="empleo" type="radio" value=1 /> Si</p></td>
												<td><p><input id="empleo_no" name="empleo" type="radio" value=0 checked/> No</p></td>
											@endif
										@else
											<td><p><input id="empleo_si" name="empleo" type="radio" value=1 @if(old('empleo') == 1) checked @endif/> Si</p></td>
											<td><p><input id="empleo_no" name="empleo" type="radio" value=0 @if(old('empleo') == 0) checked @endif/> No</p></td>
										@endif
									@endif
								</tr></table>
					...
					<div id="info_laboral_nombre" class="form-group row">
					   	...
					   	<div class="col-sm-10">
								@if(isset($info_dl->lugar_laboral))
					     		<input type="text" id="nombre_laboral" name="nombre_laboral" class="width_n form-control" placeholder="Nombre de la empresa/institución donde laboras" value="{{old('nombre_laboral', $info_dl->lugar_laboral)}}" @if ($errors->has('nombre_laboral')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['nombre_laboral']))
										<input type="text" id="nombre_laboral" name="nombre_laboral" class="width_n form-control" placeholder="Nombre de la empresa/institución donde laboras" value="<?=$_POST['nombre_laboral']?>">
									@else
										<input type="text" id="nombre_laboral" name="nombre_laboral" class="width_n form-control" placeholder="Nombre de la empresa/institución donde laboras" value="{{ old('nombre_laboral') }}">
									@endif
								@endif
					...
					<div id="info_laboral_cargo" class="form-group row">
					   	...
					   	<div class="col-sm-10">
								@if(isset($info_dl->cargo_laboral))
					     		<input type="text" id="cargo" name="cargo" class="width_n form-control" placeholder="Cargo" value="{{old('cargo', $info_dl->cargo_laboral)}}" @if ($errors->has('cargo')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['cargo']))
										<input type="text" id="cargo" name="cargo" class="width_n form-control" placeholder="Cargo" value="<?=$_POST['cargo']?>">
									@else
										<input type="text" id="cargo" name="cargo" class="width_n form-control" placeholder="Cargo" value="{{ old('cargo') }}">
									@endif
								@endif
								@if ($errors->has('cargo'))
			 						 <span class="help-block">
					...
					<div id="info_laboral_ingreso" class="form-group row">
					   	...
					   	<div class="col-sm-10">
								@if(isset($info_dl->ingreso_laboral))
									<input class="width_n form-control fecha datepicker_esp" type="date" name="ingreso" value="{{old('ingreso', date('Y-m-d', strtotime($info_dl->ingreso_laboral)))}}" @if ($errors->has('ingreso')) autofocus @endif onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
								@else
									@if(isset($_POST['ingreso']))
										<input class="width_n form-control fecha datepicker_esp" type="date" name="ingreso" value="<?=$_POST['ingreso']?>">
									@else
										<input class="width_n form-control fecha datepicker_esp" type="date" name="ingreso" value="{{ old('ingreso') }}">
									@endif
								@endif
...
@section('animaciones')
	...
	<script src="{{asset('js/visualizaCP.js')}}"></script>
